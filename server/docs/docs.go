...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/deviceLog/forceLogoutDevice": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "用户ID, 客户端ID, 下线原因",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ForceLogoutRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/deviceLog/getDeviceLogsList": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "页码, 每页大小, 筛选条件",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.GetDeviceLogsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nfc-relay/pairing/register": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.RegisterForPairingRequest"
                        }
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "是否强制接管现有会话",
                        "name": "force",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "冲突：角色已被占用，可尝试强制接管",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "500": {
                        "description": "失败：服务器内部错误",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/nfc-relay/transactions/sessions/initiate": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.InitiateTransactionSessionRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/request.TransactionSessionResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/nfc-relay/transactions/sessions/join": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.JoinTransactionSessionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nfc-relay/transactions/sessions/{transaction_id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "request.InitiateTransactionSessionRequest": {
            "type": "object",
            "required": [
                "role"
            ],
        ...
        "request.JoinTransactionSessionRequest": {
            "type": "object",
            "required": [
                "role",
                "transaction_id"
        ...
        "request.RegisterForPairingRequest": {
            "type": "object",
            "required": [
                "role"
            ],
            "properties": {
                "role": {
                    "description": "Role of the client: \"sender\" or \"receiver\"",
                    "type": "string",
                    "enum": [
                        "sender",
                        "receiver"
        ...
        "request.TransactionSessionResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "description": "创建时间戳",
                ...
                "receiver_client_id": {
                    "description": "收卡端客户端ID（如果已连接）",
                    "type": "string",
                    "example": "user-receiver-002"
                },
                "role": {
                    "description": "当前客户端的角色",
                    "type": "string",
                    "example": "transmitter"
                },
                "status": {
                    "description": "会话状态",
                    "type": "string",
                    "example": "waiting_for_peer"
                },
                "topic_config": {
                    "description": "主题配置",
                    "allOf": [
                        {
                            "$ref": "#/definitions/request.TransactionTopicConfig"
                        }
                    ]
                },
                "transaction_id": {
                ...
                "transmitter_client_id": {
                    "description": "传卡端客户端ID（如果已连接）",
                    "type": "string",
                    "example": "admin-transmitter-001"
                }
            }
        },
        "request.TransactionTopicConfig": {
            "type": "object",
            "properties": {
                "apdu_to_receiver_topic": {
                    "description": "发送到收卡端的APDU",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/apdu/to_receiver"
                },
                "apdu_to_transmitter_topic": {
                    "description": "APDU消息主题",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/apdu/to_transmitter"
                },
                "control_topic": {
                    "description": "控制主题",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/control"
                },
                "heartbeat_topic": {
                    "description": "心跳主题",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/heartbeat"
                },
                "receiver_state_topic": {
                    "description": "收卡端状态主题",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/receiver/state"
                },
                "transmitter_state_topic": {
                    "description": "状态主题 - 客户端发布自己的状态，订阅对端状态",
                    "type": "string",
                    "example": "nfc-relay/transactions/txn_123/transmitter/state"
                }
            }
        },
        ...
        "system.SysUser": {
            ...
            "properties": {
                ...
                "uuid": {
                    "description": "用户UUID, 确保有索引，作为业务唯一ID",
                    "type": "string"
                }
            }
        },
